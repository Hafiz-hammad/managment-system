...
<section className="">
  <div className="container py-10 mx-auto">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{DoctorInfo.review} Reviews</span>
          </span>
    ...
    <div className="flex justify-between text-sm gap-52">
...
<div className="flex gap-4 my-2 justify-between">
           ...
           <h1 className="font-bold text-sm">Fees: </h1>
           <h1 className="font-bold text-sm">$ {DoctorInfo.fees} </h1>
</div>
          </span>
